...
const FooterComponent = () => {
    ...
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <p className="hover:underline">Legal Provisions</p>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <p className="hover:underline">Cookies Preferences</p>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div className="py-6 px-4 bg-black dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Movies</a>, All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <p className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
