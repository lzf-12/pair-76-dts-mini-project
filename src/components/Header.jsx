    ...
    <nav className="bg-black border-black-200 px-2 sm:px-4 py-1 dark:bg-gray-900 z-0">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div className="flex md:order-2">
                <button type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="text-red-700 md:text-white rounded-lg text-sm p-2.5 mr-1" >
                ...
                <div className="hidden lg:flex lg:relative lg:right-0 lg:w-auto  lg:order-3">
                    {/* username */}
                    <div className="text-red-700 md:text-white rounded-lg text-sm p-2.5 mr-1">
                        <p>Username</p>
                    </div>
            ...
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                ...
                <li>
                <a href="#" className="block py-2 pr-4 pl-3 hover:text-white active:text-white text-neutral-400 md:border-0 md:hover:text-white-700 md:p-0 ">Movies</a>
                </li>
                <li>
                <a href="#" className="block py-2 pr-4 pl-3 hover:text-white active:text-white text-neutral-400 md:border-0 md:hover:text-white-700 md:p-0 ">New and Popular</a>
                </li>
                <li>
